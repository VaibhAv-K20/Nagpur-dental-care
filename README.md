# 🦷 Nagpur Dental Care — Premium Dental Clinic Website
...
Then replace the images in `src/assets/images/` with the client's actual photos.
...
Open to building websites for local businesses. Reach out on GitHub.
